...
&nbsp;
<a href="mailto:rohit.deshmukh@mitwpu.edu.in">
...
class RohitDeshmukh:
    def __init__(self):
        ...
        self.focus        = ["Agentic AI Systems", "MLOps", "RAG Pipelines",
                             "Computer Vision", "LLM Engineering"]

        self.currently    = "Building mlops-autoshield — a self-healing MLOps pipeline"
        self.learning     = ["Distributed training", "LLM fine-tuning at scale",
                             "System design for ML", "Production observability"]
        self.open_to      = ["AI/ML internships", "Remote freelance", "Early-stage startups"]
        self.obsession    = "Getting models out of notebooks and into the real world"
...
|---|---|
| **LLM Engineering** | Fine-tuning with LoRA/QLoRA, RLHF fundamentals, prompt optimization at scale |
| **MLOps & Infra** | Self-healing pipelines, drift detection, Prometheus/Grafana observability stacks |
| **Agentic Systems** | Multi-agent orchestration patterns, tool-use reliability, memory architectures |
...
|---|---|---|
| 🥈 **Fusion Agentic Sprint** — 2nd Place | 2026 | Multi-agent autonomous code debugger: error localization → patch generation → test validation |
| 🥇 **Coders Arena Hackathon** — 1st Place | 2025 | End-to-end tourist safety application; ranked #1 across all teams |
| 🥇 **Smart India Hackathon (SIH)** — University #1 | 2025 | Ranked **#1 / 600+ teams** at MIT-WPU qualifiers; advanced to national SIH |
